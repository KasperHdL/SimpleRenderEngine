...
class ModelImporter {
public:
    static DllExport std::shared_ptr<Mesh> importObj(std::string path, std::string filename);
    static DllExport std::shared_ptr<Mesh> importObj(std::string path, std::string filename, std::vector<std::shared_ptr<Material>>& outModelMaterials);
